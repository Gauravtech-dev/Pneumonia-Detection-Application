...
# Avoid extremely aggressive transformations because
# chest X-ray anatomical structure should be preserved.
...
# Give each class a weight based on its frequency.
...
plt.title(
    "Improved ResNet18 Confusion Matrix"
)
